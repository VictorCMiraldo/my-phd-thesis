...
\begin{myhs}
\begin{code}
instance (NotElem a prim , Deep prim a)  => GDeepAtom prim (P False) a where
instance (Elem a prim)                   => GDeepAtom prim (P True) a where
\end{code}
\end{myhs}
